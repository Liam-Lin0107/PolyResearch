...
def MertonTest():
    ...
    # poly_coef = [-100, 1]
    #
    # process = MertonByMC(S0=S0, r=r, sigma=sigma, T=T, poly_coef=poly_coef, jump_intensity=jump_intensity,
    #                      jump_mean=jump_mean, jump_var=jump_var)
    # if not my_pc:
    #     print(process.getStastic(save_data=True, save_dir="D:\\Users\DZLin\\Oplynomial_Option_Reserch-newFindInterval"
    #                                                       "\\PolynomialPricingMethod\\tests\\Data\\MJDSimulationTest.txt"))
    # else:
    #     print(process.getStastic(save_data=True, save_dir=r"/PolynomialPricingMethod/tests/Data/MJDSimulationTest.txt"))
